...
warn, error, fatal`. If you choose `warn`, you'll warning, error, and
...
Going a bit deeper, there's the [test coverage
report](https://firepear.github.io/petrel/assets/coverage.html), which
is generated by my `pre-commit` hook. Speaking of, that hook also
runs
